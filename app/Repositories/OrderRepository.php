...
class OrderRepository extends BaseRepository
{
    ...
    public function storeOrder($request, $settings): mixed
    {
        ...
        if (! $eligible) {
            throw new DurrbarBadRequestException('COULD_NOT_PROCESS_THE_ORDER_PLEASE_CONTACT_WITH_THE_ADMIN');
        }
        // Create Intent
